(() => {
    ...
    function _0x534623() {
      ...
      $(".startdelete_wf").html(deleteIcon);
      _0x23412f(_0x1e94bc);
      _0x544d75 = {};
      _0x2c96cd = [];
      _0x521ff1 = {};
    ...
    function _0x23412f(_0xfbd7f1 = "root", _0x41bc25 = 0x1) {
      $(".workflows_tbody_delete").html(
        '<tr><td colspan="3">Loading workflows...</td></tr>'
      );
      rest_api_call(
        "workflow/" +
          getLocationId() +
        ...
        .then((_0x3654ca) => {
          if (
            ...
            $(".workflows_tbody_delete").html(
              '<tr><td colspan="3">Failed to fetch workflows</td></tr>'
            );
          }
        })
        ["catch"]((_0x5d8492) => {
    ...
    function handleFetchError(errorMessage = "") {
      ...
      $(".startdelete_wf").removeAttr("disabled").html(deleteIcon);
  
      // Display an error message in the console data area
      $(".console_data_delete").html(
        '<tr><td colspan="3"><p class="error p-2">Failed to delete workflow</p></td></tr>'
      );
    }
              ...
              `
                  ...
                  <a class="group workflow_script_sm_delete skiptranslate text-left mx-1 pb-2 md:pb-3 text-sm font-medium 
                      ...
                      <span class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4 w-4 mr-1" fill="currentColor">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <div class="modal-header--inner">
                            <h1 class="font-bold text-2xl text-left text-dark">Delete Workflows</h1>
